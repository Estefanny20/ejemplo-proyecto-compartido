...
/*var ejemploname=RickAndMorty.results[1].name;
var contenedorname = document.getElementById('contenedorname');
contenedorname.innerHTML=ejemploname;

contenedorname = document.getElementById('contenedorname');
contenedorname.innerHTML=ejemploname;


var contenedorimage= RickAndMorty.results[1].image;
function contenedorimagen() {

    //creo un div
    let div =$("<div></div>");
    //agregando class a el div
    div.addClass("pic card");
    //agregar imagen
    let img=$("<img></img>");
    //agrego atributos "src" y le indico que parte de la data tiene la imagen
    img.attr("src",RickAndMorty.results[1].image);
    //agrego clase al img
...
name.append(RickAndMorty.results.name);
div.append(name);
...
/*RickAndMorty = {
    ...
    "results": [
        ...
        var contenedorname = document.getElementById('contenedorname');
contenedorname.innerHTML=RickAndMorty.results.name+''+RickAndMorty.results.species*/